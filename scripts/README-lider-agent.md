...
## 6) Extraccion de transferencias (Santander)
...
## 7) Finanzas unificado (boletas foto + merge)

Ver `scripts/README-finanzas-agent.md` para:
- fotos Telegram con `qwen3-vl-30b-a3b-instruct`
- CSV maestro `data/finanzas_movimientos.csv`
- config OpenClaw agente finanzas + Telegram
